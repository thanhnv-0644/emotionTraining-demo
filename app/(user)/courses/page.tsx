...
const coursesData: Course[] = [
  {
    ...
    progress: 100,
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuBli4ztgt2jf1CFIqvVhUS2ApjYj-bvD9jACDHcRxVtWKOrBwdke87hPtqp8nCT2SiwLfUsunyoO8r0Lz3V3skox6aocUUTzAvGjoE0_huIxaWyVSiR89JWQ35ySEuDThXL_3Xy1tDavbXSM8ltSB3GmhSHI3QBoMcBf0aznwePNYo41AG8ApaPR1sGQNoJA33WfGdMKgKqJRzxHbPdt15aKJIIJOHTaQfe1NPDf0bDPxepNIg4shTf-mU9uUC8lsIfvu9K9ZxxKE98",
    category: "Basics",
    lessons: 5,
    duration: "25m",
    completed: true,
    ...
    <>
        ...
        <div className="flex items-center gap-4">
          <div className="relative w-full max-w-xs hidden sm:block">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-lg border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 focus:ring-2 focus:ring-primary text-sm"
            />
          </div>
      ...
      <div className="p-8 space-y-8">
        <div className="flex gap-4 border-b border-slate-200 dark:border-slate-800">
          <button className="px-4 py-3 text-sm font-bold text-primary border-b-2 border-primary">
            In Progress ({inProgressCount})
          </button>
          <button className="px-4 py-3 text-sm font-medium text-slate-500 hover:text-slate-900 dark:hover:text-slate-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {coursesData.map((course) => (
            <div
              key={course.id}
              className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden flex flex-col group hover:shadow-md transition-shadow"
            >
              ...
              <div className="p-5 flex-1 flex flex-col">
                <div className="flex items-center gap-2 mb-3">
                  <span className="px-2 py-0.5 bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400 text-[10px] font-bold uppercase rounded tracking-wider">
                    {course.category}
                  </span>
                </div>
