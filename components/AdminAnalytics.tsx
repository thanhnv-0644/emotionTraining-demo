  ...
  return (
    <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
            ...
            <div className="grid grid-cols-6 grid-rows-6 gap-1 aspect-square max-w-[300px] mx-auto">
              {[
                90, 10, 5, 10, 5, 5, 5, 80, 20, 5, 5, 10, 10, 20, 90, 10, 10, 5,
                5, 10, 5, 70, 40, 20, 10, 5, 10, 30, 80, 5, 5, 5, 5, 10, 10, 90,
              ].map((opacity, idx) => (
                <div
                  key={idx}
      ...
      <footer className="p-8 border-t border-slate-200 dark:border-slate-800 mt-auto flex items-center justify-between text-[10px] text-slate-500 font-medium uppercase tracking-widest">
        <p>© 2024 Emotion Training & Evaluation System - Research Division</p>
  ...
  return (
    <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
      ...
      <div className="mt-2 flex items-end justify-between">
        ...
        <span
          className={`text-xs font-bold px-2 py-1 rounded-full flex items-center gap-1 ${trendColor}`}
        >
          {trendType !== "static" && (
  ...
  return (
    <div className="space-y-2">
      <div className="flex justify-between text-xs font-bold">
        <span>{label}</span>
        <span
          className={color === "primary" ? "text-primary" : "text-slate-500"}
        >
          {value}% Mastery
        </span>
      </div>
