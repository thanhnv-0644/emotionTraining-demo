            ...
            <table className="w-full text-left text-sm text-slate-600 dark:text-slate-400">
              ...
              <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                {[
                  ...
                  { name: 'Sarah Chen', email: 'sarah.chen@example.com', role: 'Student', status: 'Active', lastLogin: '1 hour ago', progress: 100, avatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCWZwiftgu4AMhbzaLfq4zDAip5gXzPW3qNmE8lWEZBNFHeHJhf5eJdHmOsjI8fwVquHEZxhvGcChIKIetJDH6r3_k1r0ulDfMvglis8QVkCpB_lhPxI2JqSSczOh4QEoPb6puB6f26-TS7aiVkoXWVV5ejvWJSRUc9yePGjKZfAj9cH8qiTu0D41JZefEr20nyCHPTg8w4afgS57EhFq1Xa0mAzpEU2-At_8f1x9C0E090pTq1QEBIz8fPOH1NOt5_NBScrdI66iit' },
